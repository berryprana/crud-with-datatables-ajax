...
<body>
    ...
    <div class="container">
        <div class="card"> 
            <div class="card-body">
                <!-- start TOMBOL TAMBAH -->
                <a href="javascript:void(0)" class="btn btn-info" id="tombol-tambah">Add Data</a>
                <br><br>
                <!-- end TOMBOL -->
                <!-- start TABLE -->
                <table class="table table-striped table-bordered table-sm" id="table_mahasiswa">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    <label for="name" class="col-sm-12 control-label">Nama Mahasiswa</label>
                                    <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    <label for="name" class="col-sm-12 control-label">Umur</label>
                                    <div class="col-sm-12">
                ...
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        ...
                        success: function (data) { //jika berhasil 
                            ...
                            var oTable = $('#table_mahasiswa').dataTable(); //inialisasi datatable
            ...
            $.ajax({
                ...
                success: function (data) { //jika sukses
                    setTimeout(function () {
                        ...
                        var oTable = $('#table_mahasiswa').dataTable();
                        oTable.fnDraw(false); //reset datatable
                    });
